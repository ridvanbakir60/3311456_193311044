...
import 'package:asi/pages/doz.dart';
...
//  asilar.add(name);});}
  ...
  void addToVaccList(String asiName, String dozBilgim, String aralikBilgisi) {
      vaccList.add([false, asiName, dozBilgim, Icon(Icons.abc)]);
    }
    ...
    return Scaffold(
      floatingActionButton: FloatingActionButton(
        ...
        mini: true,
        backgroundColor: Color.fromARGB(255, 68, 148, 146),
        ...
        Padding(
          ...
          child: ClipRRect(
            ...
            child: Stack(children: [
              Center(child: Image.asset('assets/images/asi2.png')),
              Padding(
